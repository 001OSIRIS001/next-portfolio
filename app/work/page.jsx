...
const projects = [
  {
    ...
    category: "frontend",
    title: "project 1",
    description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique, repellat.",
    stack: [{ name: "Html 5" }, { name: "Css 3" }, { name: "JavaScrip" }],
  ...
  },
  {
    ...
    live: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique, repellat.",
    github: "",
  },
  {
    num: "03",
    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          <div className="w-ful xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
            <div className="flex flex-col gap-[30px] h-[50%]">
              <div className="text-8xl leading-none font-extrabold text-transparent text-outline">
                {project.num}
              </div>
              <h2 className=" group-hover:text-accent text-[42px] font-bold leading-none text-white transition-all duration-500 capitalize">
